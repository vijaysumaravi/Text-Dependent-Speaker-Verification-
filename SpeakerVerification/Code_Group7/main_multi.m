...
GMM_FEATURES_OPT = [1 0 1];                     % Request features for GMM [LPC PLP GFCC]
KNN_FEATURES_OPT = [0 0 1];                     % Request features for KNN [LPC PLP GFCC]
SVM_FEATURES_OPT = [1 1 1];                     % Request features for SVM [LPC PLP GFCC]
NB_FEATURES_OPT = [0 1 1];                      % Request features for NB [LPC PLP GFCC]
V_THRES = 0.45;                                 % Voiced/unvoiced threshold
VOICED_ONLY = true;                             % Analyze only voiced frames (bool)
% Feature set to load for each model
GMM_FEATURE_SET = 'featuresLPC_GFCC.mat';
KNN_FEATURE_SET = 'featuresGFCC.mat';
SVM_FEATURE_SET = 'featuresLPC_PLP_GFCC.mat';
NB_FEATURE_SET = 'featuresPLP_GFCC.mat';
% GMM
IMPLEMENT_GMM = true;                           % Implement GMM-log likelihood (bool)
NUM_GAUSSIAN = 8;                               % Number of Gaussian mixtures
% k-NN
...
if IMPLEMENT_SF
    ...
    regressor = fitrlinear(train_scores,sampledTrainLabels,'Learner',...
        'leastsquares','Regularization','lasso');
